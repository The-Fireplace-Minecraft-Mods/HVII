 ...
 */
public class PatsGenericThrowableTargeting extends PatsRendererBase {

    float initialVelocity;
    float pitchOffset;
    float gravityVelocity;

    public PatsGenericThrowableTargeting(float initialVelocity, float pitchOffset, float gravityVelocity){
