 ...
 */
public class FatsBowTargeting implements IFatsRenderer {
    Minecraft mc;
    double posX;
    double posY;
    double posZ;
    ...
    @Override
    public void handleRender(Minecraft mc, boolean primaryRenderEnabled, boolean secondaryRenderEnabled, int projectileTickCount, EnumParticleTypes primaryParticle, EnumParticleTypes secondaryParticle, boolean extensiveSecondary) {
        this.mc=mc;
        ...
        if(mc.player.getItemInUseCount() > 0){
            ...
            if ((double)velocity >= 0.1D){
                resetPos();
                setAim(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 0.0F);
                ...
                if(extensiveSecondary){
                    resetPos();
                    setAimX(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F, false, false, false);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                    resetPos();
                    setAimX(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F, true, false, false);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                    resetPos();
                    setAimX(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F, false, false, true);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                    resetPos();
                    setAimX(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F, false, true, false);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                    resetPos();
                    setAimX(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F, true, true, false);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                    resetPos();
                    setAimX(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F, true, false, true);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                    resetPos();
                    setAimX(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F, false, true, true);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                    resetPos();
                    setAimX(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F, true, true, true);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                }else{
                    resetPos();
                    setAim(mc.player, mc.player.rotationPitch, mc.player.rotationYaw, velocity*3.0f, 1.0F);
                    for(int i = 0; i<projectileTickCount && secondaryRenderEnabled; i++){
                        updateSecondary(i, projectileTickCount);
                    }
                }
